  ...
  dependencies = {
    {
      ...
      opts = function(_, opts)
        ...
        maps.n["<A-t>"] = { '<Cmd>execute v:count . "ToggleTerm"<CR>', desc = "Toggle terminal" }
        maps.t["<A-t>"] = { "<Cmd>ToggleTerm<CR>", desc = "Toggle terminal" }
        maps.i["<A-t>"] = { "<Esc><Cmd>ToggleTerm<CR>", desc = "Toggle terminl" }
